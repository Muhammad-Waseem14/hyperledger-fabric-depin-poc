...
async function getClimateRecord(req, res) {
    ...
    try {
        ...
        const resultBytes = await contract.evaluateTransaction('getClimateRecord', recordId);
...
async function getAllClimateRecords(req, res) {
    try {
        ...
        const resultBytes = await contract.evaluateTransaction('getAllClimateRecords');
        const resultJson = utf8Decoder.decode(resultBytes);
        const result = JSON.parse(resultJson);
